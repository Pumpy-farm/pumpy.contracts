...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public pmpExchangeRouterAddress;
    ...
    constructor(
        ...
        if (isAutoComp) {
            ...
            pmpExchangeRouterAddress = _uniRouterAddress;

            earnedToPMPPath = [earnedAddress, PMPAddress];
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        IERC20(earnedAddress).safeIncreaseAllowance(
            pmpExchangeRouterAddress,
            buyBackAmt
        );

        IPancakeRouter02(pmpExchangeRouterAddress)
            .swapExactTokensForTokensSupportingFeeOnTransferTokens(
            buyBackAmt,
            0,
            earnedToPMPPath,
    ...
    function setPaths(
        ...
        address _pmpExchangeRouterAddress
    ) public {
          ...
          pmpExchangeRouterAddress = _pmpExchangeRouterAddress;
    }
}
